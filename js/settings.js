...
$('#btnExportData').addEventListener('click',()=>{
  const data={
    ...
    expo_links:localStorage.getItem('expo_links')||'[]',
    expo_goals:localStorage.getItem('expo_goals')||'[]',
...
$('#importFileInput').addEventListener('change',e=>{
  ...
  reader.onload=function(){
    try{
      ...
      if(data.expo_links)localStorage.setItem('expo_links',data.expo_links);
      if(data.expo_goals)localStorage.setItem('expo_goals',data.expo_goals);
...
$('#btnClearAll').addEventListener('click',()=>{
  ...
  localStorage.removeItem('expo_links');localStorage.removeItem('expo_goals');
